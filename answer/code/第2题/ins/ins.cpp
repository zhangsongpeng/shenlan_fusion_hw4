...
int main(int argc, char **argv)
{
    ...
    path.push_back("/home/zsp/Desktop/imu/data7/time.csv");
    path.push_back("/home/zsp/Desktop/imu/data7/accel-0.csv");
    path.push_back("/home/zsp/Desktop/imu/data7/gyro-0.csv");
    path.push_back("/home/zsp/Desktop/imu/data7/gps_time.csv");
    path.push_back("/home/zsp/Desktop/imu/data7/gps-0.csv");
    path.push_back("/home/zsp/Desktop/imu/data7/ref_pos.csv");
    path.push_back("/home/zsp/Desktop/imu/data7/ref_vel.csv");
    path.push_back("/home/zsp/Desktop/imu/data7/ref_att_quat.csv");
    ReadData(path);
    gt_ofs.open("/home/zsp/Desktop/imu/data7/gt.txt", std::fstream::out);
    pose_ofs.open("/home/zsp/Desktop/imu/data7/pose.txt", std::fstream::out);
    sv_ofs.open("/home/zsp/Desktop/imu/data7/sv.txt", std::fstream::out);
    FGs.clear();
    
    YAML::Node yaml_node = YAML::LoadFile("/media/zsp/zhang/a/shenlan/Fusion/chapter4/hw/other/ins/param.yaml");
